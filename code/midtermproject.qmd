...
Destructive approaches limit a continuous evaluation of environmental effects on a highly dynamic plant response such as crop yield [@mochida2019]. Image-based solution add efficiency to the data collection process

Lettuce canopy architecture could be described using two-dimensional (2D) top view captures. Besides canopy projected area, additional shape properties provide a more comprehensive description of plant structure [@devylder2012]

Paragraph 4

# Hypothesis and objectives

HYPOTHESIS: Lettuce fresh weight estimation per plant is accurately estimated using potential predictors coming from an RGB image analysis and machine learning models.
